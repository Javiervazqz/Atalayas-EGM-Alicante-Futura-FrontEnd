    ...
    <div className="flex min-h-screen bg-background font-sans text-foreground">
      ...
      <main className="flex-1 overflow-auto flex flex-col relative">
        <PageHeader 
          ...
          description={isEditing ? "Modifica los detalles del servicio corporativo." : (service.isPublic ? "Servicio oficial Atalayas EGM" : "Servicio privado de empresa")}
                ...
                {isEditing && canModify ? (
                  <section className="bg-card border border-border rounded-[2.5rem] p-8 lg:p-12 shadow-sm space-y-8 animate-in fade-in duration-300">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">URL Imagen Portada</label>
                  ...
                  <section className="bg-card border border-border rounded-[2.5rem] p-8 lg:p-12 shadow-sm animate-in fade-in duration-500">
                    <div className="flex items-center gap-3 mb-8">
                      <span className={`text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-[0.15em] border ${service.isPublic ? 'bg-primary/5 text-primary border-primary/20' : 'bg-secondary/5 text-secondary border-secondary/20'}`}>
                        {service.isPublic ? '🌐 Público' : '🔒 Privado'}
                      </span>
                    </div>

                    <h2 className="text-3xl font-bold mb-8 tracking-tight">{service.title}</h2>
                    ...
                    {service.mediaUrl && (
                      <div className="overflow-hidden rounded-[2.5rem] border border-border shadow-sm group mt-10">
