...
// 1. Creamos un componente interno que maneja la lógica del formulario
...
// 2. Componente principal envuelto en Suspense
    ...
    <div className="min-h-screen flex font-sans bg-background">
      <div className="w-full lg:w-1/2 flex flex-col relative z-10">
        ...
        <main className="flex-1 flex items-center justify-center px-6 lg:px-12 py-10">
          <Suspense fallback={<div className="text-center font-bold">Cargando formulario...</div>}>
