        ...
        <div className="max-w-2xl mx-auto">
          ...
          <header className="mb-10">
            <button onClick={() => router.back()}
              className="text-[#0071e3] font-semibold mb-4 flex items-center gap-1 group">
            ...
            <p className="text-[#86868b] mt-2 text-lg">Este servicio será visible solo para los empleados de tu empresa.</p>
          </header>

          {/* Aviso de visibilidad fija */}
          <div className="mb-6 p-4 rounded-2xl bg-blue-50/50 text-blue-700 border border-blue-100">
            <p className="text-sm font-medium">🏢 Los servicios que crees aquí son privados y exclusivos para los empleados de tu empresa.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-6">
            ...
            <section className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-6">
              ...
              <div className="space-y-2">
                <label className="block text-xs font-bold text-[#86868b] ml-1">Imagen de portada (URL)</label>
