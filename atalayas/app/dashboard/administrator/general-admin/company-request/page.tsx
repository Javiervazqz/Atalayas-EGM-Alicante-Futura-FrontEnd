...
const statusConfig = {
  ...
  APPROVED: { label: 'Aprobada', color: '#34c759', bg: 'rgba(52,199,89,0.1)' },
  REJECTED: { label: 'Rechazada', color: '#ff3b30', bg: 'rgba(255,59,48,0.1)' },
};
...
export default function CompanyRequestsPage() {
  ...
  return (
    <div style={{ fontFamily: appleFont, minHeight: '100vh', background: '#f5f5f7' }}>
      {/* Header */}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: selected ? '1fr 380px' : '1fr', gap: '0', minHeight: 'calc(100vh - 120px)' }}>
        {/* Lista */}
        <div style={{ padding: '24px 32px', overflowY: 'auto' }}>
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '60px 0' }}>
              ...
              <p style={{ color: '#86868b', fontSize: '14px' }}>No hay solicitudes {filter !== 'ALL' ? statusConfig[filter].label.toLowerCase() + 's' : ''}</p>
            </div>
          ) : (
