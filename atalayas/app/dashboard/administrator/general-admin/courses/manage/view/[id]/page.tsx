          ...
          <>
            <PageHeader
              ...
              action={
                <div className="flex">
                  {/*<Link
                    href={`/dashboard/administrator/general-admin/courses/${id}`}
                  ...
                  >
                    <i className="bi bi-eye-fill"></i> Vista Empleado
                  </Link>*/}
                  <Link
                ...
                <div className="p-4 border-b border-border flex flex-col sm:flex-row items-center justify-between gap-4 bg-muted/30">
                  ...
                  <div className="relative w-full sm:max-w-xs">
                    ...
                    <input
                      ...
                      className="w-full bg-background border border-border rounded-xl pl-10 pr-4 py-1.5 text-xs outline-none focus:border-primary transition-all font-medium"
                    />
                  </div>
                </div>
