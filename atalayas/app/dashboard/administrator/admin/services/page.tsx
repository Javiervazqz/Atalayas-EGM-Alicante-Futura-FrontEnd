        ...
        <div className="max-w-6xl mx-auto px-8 py-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            <div>
              ...
              <p className="text-[#86868b] mt-1 text-lg">Administra los servicios de tu empresa</p>
            </div>
            <div className="flex items-center gap-4">
              <SearchInput value={searchQuery} onChange={setSearchQuery} placeholder='Buscar servicios...' />
              <Link href="/dashboard/administrator/admin/services/new" className="bg-[#0071e3] text-white px-6 py-2.5 rounded-full font-semibold hover:bg-[#0077ed] transition-all shadow-md">
                Nuevo Servicio
              </Link>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 mb-10 overflow-x-auto pb-2 no-scrollbar">
            {[
              ...
              <button
                ...
                className={`shrink-0 px-6 py-2 rounded-full text-sm font-bold transition-all ${filter === item.id ? 'bg-[#1d1d1f] text-white shadow-lg' : 'bg-white text-[#86868b] border border-gray-200 hover:border-gray-400'
                  }`}
              >
                {item.label}
              </button>
